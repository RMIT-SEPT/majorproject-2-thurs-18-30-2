...
public class StartingUpService {
    ...
    public void runApplication(ApplicationReadyEvent event) {
        ...
        try {
            ...
            employeeSchedule1.setDate(formatterDate.parse("2020-11-10"));
            ...
            employeeSchedule2.setDate(formatterDate.parse("2020-11-11"));
            ...
            employeeSchedule3.setDate(formatterDate.parse("2020-11-11"));
            ...
            employeeSchedule4.setDate(formatterDate.parse("2020-11-12"));
            ...
            employeeSchedule5.setDate(formatterDate.parse("2020-11-12"));
            ...
            employeeSchedule6.setDate(formatterDate.parse("2020-11-11"));
            ...
            employeeSchedule7.setDate(formatterDate.parse("2020-11-10"));
            ...
            employeeSchedule8.setDate(formatterDate.parse("2020-11-12"));
            ...
            employeeSchedule9.setDate(formatterDate.parse("2020-11-12"));
            ...
            employeeSchedule10.setDate(formatterDate.parse("2020-11-12"));
